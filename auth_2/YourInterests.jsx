...
const YourInterests = ({ navigation }) => {
    ...
    // Handle check/uncheck item change and update selected items in state and AsyncStorage
    // const handleChange = (category, i) => {
    //     const updatedFields = [...fields];
    //     updatedFields.forEach(item => {
    //         if (item.name === category) {
    //             item.details[i].checkStatus = !item.details[i].checkStatus;
    //         }
    //     });

    //     // Track selected items in an array
    //     const selectedItem = updatedFields
    //         .find(item => item.name === category)
    //         .details[i];

    //     if (selectedItem.checkStatus) {
    //         // Add to selected items if checked
    //         setSelectedItems(prevItems => {
    //             const newItems = [...prevItems, selectedItem];
    //             AsyncStorage.setItem('selectedItems', JSON.stringify(newItems));  // Save to AsyncStorage
    //             return newItems;
    //         });
    //     } else {
    //         // Remove from selected items if unchecked
    //         setSelectedItems(prevItems => {
    //             const newItems = prevItems.filter(item => item.title !== selectedItem.title);
    //             AsyncStorage.setItem('selectedItems', JSON.stringify(newItems));  // Update AsyncStorage
    //             return newItems;
    //         });
    //     }

    //     setFields(updatedFields);  // Update state with the new selection
    // };
