...
export default function AuthUser({ navigation }) {
  ...
  const handleContinue = async () => {
    ...
    if (!genderOptions.includes(gender)) {
      ...
      GlobalToast.showError("Invalid Gender", "Please select a valid gender.");
      return;
    }
    ...
    try {
      ...
      if (result.success) {
        GlobalToast.showSuccess(result.message || "Details updated successfully!"); // you can replace with Toast if you want
        ...
        GlobalToast.showError(result.message || "Failed to update details.");
      }
    } catch (error) {
      console.error(error);
